...
* **Origem:** Dataset público a ser definido.
* **Licença:** A ser definido.
* **Quantidade:** A ser definido.
* **Características:** Contém fotos de moedas do Real, divididas em imagens de moedas únicas e múltiplas moedas com fundos ruidosos.
